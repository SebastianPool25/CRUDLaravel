    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <header class="mt-6 mb-10">
                            ...
                            <div>
                                ...
                                <p class="text-lg">Fecha:
                                    {{$detalle_bug->created_at->formatLocalized('%A %d %B %Y')}} </p>
                            </div>
                        </header>
                        ...
                        <main>
                            ...
                            <div class="bg-white p-6 rounded-md shadow-md grid grid-cols-2 gap-2">
                                <div>
                                    ...
                                    <p class="text-lg">{{$detalle_bug->description}} </p>
                                </div>

                                <div>
                                    <h2 class="text-2xl font-bold mb-4">Plataforma</h2>
                                    <p class="text-lg">
                                        {{ $detalle_bug->plataforma }}
                                    </p>
                                </div>
                                <div class="col-span-2">
                                    <h2 class="text-2xl font-bold mt-6 mb-4">Solución</h2>
                                    <p class="text-lg">
                                        {{ $detalle_bug->solution }}
                                    </p>
                                </div>
                            </div>
                        </main>
                ...
                <div class="px-6 py-6">
                <form class="inline-block" action="{{ route('bugs.destroy', $detalle_bug->id) }}" method="POST">
                                @method("DELETE")
                                @csrf
                    <button type="sumbiit" class="bg-blue-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded">
