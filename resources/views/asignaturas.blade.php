                    ...
                    <table class="w-full border-collapse border border-gray-400">
                        ...
                        @foreach ($asignaturas as $asignatura)
                            <tr class="bg-white">
                                ...
                                <td class="py-2 px-4 border border-gray-400"> <center>{{ $asignatura->clave }}</center> </td>
                                <td class="py-2 px-4 border border-gray-400"> <center>{{ $asignatura->semestre }}</center> </td>
