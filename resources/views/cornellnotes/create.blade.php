                    ...
                    @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                id="titulo" name="titulo" type="text" placeholder="Ingresa el título">
                        </div>
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                placeholder="Ingrese sus palabras clave separelas por coma ( , )">
                        </div>
                        <div class="mb-6">
                            ...
                            <textarea
                                ...
                                id="apuntes" name="apuntes" placeholder="Ingresa sus apuntes"></textarea>
                        </div>
                        <div class="mb-6">
                            ...
                            <textarea
                                class="w-full bg-white border border-red-400 rounded-md py-2 px-4 text-gray-700 leading-tight resize-none h-32 focus:outline-none focus:bg-white focus:border-red-500"
                                id="conclusion" name="conclusion" placeholder="Ingresa la conclusión"></textarea>
                        </div>
